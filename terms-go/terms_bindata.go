...
func termsMd() (*asset, error) {
	...
	info := bindataFileInfo{name: "TERMS.md", size: 16155, mode: os.FileMode(420), modTime: time.Unix(1562230299, 0)}
...
func warrantyMd() (*asset, error) {
	...
	info := bindataFileInfo{name: "WARRANTY.md", size: 549, mode: os.FileMode(420), modTime: time.Unix(1562230299, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
